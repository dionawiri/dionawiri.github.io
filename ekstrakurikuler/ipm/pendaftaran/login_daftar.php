    ...
    <div class="global-container">
        <div class="card login-form shadow">
            <div class="card-body text-center">
                ...
                <img src="../../img/Logo_Ekstra/IPM.png"  style="width: 29px;  margin: 2px 0px 10px" />
            </div>
            <div class="card-text">
                <form action="" method="POST">
                    <div class="mb-3">
                        <input type="username" class="form-control" name="username" id="username"
                            aria-describedby="emailHelp " autofocus placeholder="NIS"  autocomplete="off" required/>
                    </div>
                    <div class="mb-3">

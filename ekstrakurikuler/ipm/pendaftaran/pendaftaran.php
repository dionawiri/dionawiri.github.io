...
if(isset($_POST['submit'])) {
    ...
    //  cek data, apakah NIS sudah didaftarkan
     if (isset($_POST['nis'])) {
        ...
        $query = mysqli_query($conn_ekstra, "SELECT nis FROM data_ipm WHERE nis = '$nis'"); 
    ...
    $generateId = 'IPM'.date('Y') .sprintf("%05s", $d->id + 1);


        // pros insert data
    $insert = mysqli_query($conn_ekstra, "INSERT INTO data_ipm
        VALUES
        ( '".$generateId."',
        '".$_POST['nama']."',
        '".$_POST['nis']."',
...
<html lang="en">
  ...
  <link rel="icon" href="../../img/Logo_Ekstra/IPM.png" type="image/gif" sizes="16x16" />
    ...
    <title>Form Pendaftaraan | IPM</title>
  </head>
  <!-- icon fontawsem -->
    ...
    <div class="form_wrapper">
      <div class="form_container">
        <div class="title_container">
          <h2>Formulir Pendaftaran Ekstrakulikuler IPM</h2>
        </div>

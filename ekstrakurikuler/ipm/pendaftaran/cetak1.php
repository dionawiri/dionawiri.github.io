<?php 
	...
	$peserta = mysqli_query($conn_ekstra, "SELECT * FROM data_ipm
		WHERE id = '".$_GET['id']."' ");
...
<link href="https://fonts.googleapis.com/css2?family=Kaisei+Tokumin&display=swap" rel="stylesheet">
    ...
    <title>Kartu Pendaftaraan | IPM</title>
  </head>
  <body>
          ...
          <div class="container top">
            <div class="row justify-content-center">
              ...
              <div class="col-5 text-end logo d-flex">
                <img src="../../img/Logo_Ekstra/IPM.png" width=" 37" style="border-radius: 0%; margin-left: auto" alt="" />
              </div>
            </div>
          </div>
          <h4 class="pt-5 text-center fw-bolder judul">KARTU PENDAFTARAN EKSTRAKURIKULER <br>IPM</h4>
          <!-- isi -->
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-8">

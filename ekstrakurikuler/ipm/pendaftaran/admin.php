...
<title>Daftar Anggota | IPM</title>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light shadow navbar-expand-sm "style="background-color: #fd9800;" >
    ...
    <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link" href="login_daftar.php" target="_blank"style="color: black">Login Siswa <i class="fas fa-user-friends" ></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="logout.php" style="color: black">Logout <i class="fas fa-sign-out-alt" style='font-size:17px; color: black' ></i></a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="container mt-5">
  <h1 class="text-center jdl fw-bold">Daftar Calon Anggota <span>IPM</span></h1>
</div>
    ...
    <nav class="navbar navbar-light  " style="background-color:white;">
      <div class="container-fluid" >
        <form class="d-flex" action="" method="POST">
          ...
          <img width="30px" src="../../img/ekstra/Ipm/load.gif" class="loader">
        </form>

<?php 
	...
	if(isset($_POST['login'])){
		...
		if(mysqli_num_rows($cek) > 0){
			...
			$_SESSION['stat_login_paskib'] = true;
			$_SESSION['id'] = $a->id;
...
<head>
    ...
    <title>Login Siswa | PASKA PERSADA</title>
                ...
                <form action="" method="POST">
                    <div class="mb-3">
                        <input type="username" class="form-control" name="username" id="username"
                            aria-describedby="emailHelp " autofocus placeholder="Username"  autocomplete="off" required/>
                    </div>
                    <div class="mb-3">

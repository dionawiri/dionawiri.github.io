            ...
            <div class="card text-center">
              <div class="card-header">
                <ul class="nav nav-pills card-header-pills pe-2 ps-2">
                  <li class="nav-item">
                    <a class="btn btn-light fw-bolder" style="background-color: #ff0000; color: #000000; border-color: #000000" href="login_daftar.php" title="Klik Untuk Mendaftar Ekstrakulikuler Tari" role="button" target="_blank"
                  ...
                  <li class="nav-item wa_admin">
                    <a class="nav-link" href="https://wa.me/6285155097533" target="_blank"
                      >Admin&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="me-2 bi-whatsapp" viewBox="0 0 16 16">
                        <path
              ...
              <div class="card-body text-capitalize">
                ...
                <p class="card-body inf text-muted fst-italic">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
                    ...
                    /></svg
                  >&nbsp; Apabila Ada Kesalahan dalam Penginputan Data, Harap Hubungi <br />
                  Admin Dan Cantumkan Kartu Pendaftaraan Yang Akan Di Ubah/Hapus.
                </p>
                <a href="cetak.php?id=<?php echo $_GET['id'] ?>" target="_blank" role="button" class="btn btn-primary" style="background-color: #ff0000; color: rgb(255, 255, 255); border-color: #ff0000"
                  >Cetak Kartu &nbsp;

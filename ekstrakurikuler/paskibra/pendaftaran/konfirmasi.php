...
<title>konfirmasi Pendaftaran | PASKA PERSADA</title>

</head>
<body>
<!--  Navbar -->
<nav class="navbar fixed-top navbar-expand-lg navbar-light shadow navbar-expand-sm "style="background-color: #ff0000;" >
  <div class="container " >
...
<!-- navbar akhir -->
    ...
    if ( !isset($_SESSION["stat_login_paskib"])) {
    ...
    $kelas = query("SELECT * FROM data_paskib WHERE  null ");
...
<div class="container mt-5">
  <h1 class="text-center jdl fw-bold">Daftar Pencarian  <span>PASKA PERSADA</span></h1>
</div>
...
<?php foreach($kelas as $row) : ?>
  ...
  <td>
    <!-- <div class="button-onclick"> -->
      ...
      <a class="btn btn-warning "style="background-color: #ed1b2e; margin:5px; color: #ffffff; border-color:#000000 ;  href="cetak1.php?id=<?= $row["id"]; ?>" role="button">
...
<a class="btn  btn-light fw-bolder"
  style="background-color: #ed1b2e; margin:5px; color: #ffffff; border-color:#000000 ;" href="pendaftaran.php"

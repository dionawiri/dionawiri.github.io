<?php 
	...
	$peserta = mysqli_query($conn_ekstra, "SELECT * FROM data_paskib
		WHERE id = '".$_GET['id']."' ");
...
<link href="https://fonts.googleapis.com/css2?family=Kaisei+Tokumin&display=swap" rel="stylesheet">
    ...
    <title>Kartu Pendaftaraan | PASKA PERSADA</title>
  </head>
  <body>
          ...
          <div class="container top">
            <div class="row justify-content-center">
              <div class="col-5 text-start logo d-flex">
                <img src="../../img/logomuhi/Muhi.png" width="70" style="margin-right: auto" alt="" />
              </div>

              <div class="col-5 text-end logo d-flex">
                <img src="../../img/Logo_Ekstra/Paskib.png" width=" 50" style="border-radius: 0px; margin-left: auto" alt="" />
              </div>
            </div>
          </div>
          <h4 class="pt-5 text-center fw-bolder judul">KARTU PENDAFTARAN EKSTRAKURIKULER <br>PASKIB</h4>
          <!-- isi -->
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-8">

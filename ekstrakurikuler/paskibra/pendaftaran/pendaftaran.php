...
if(isset($_POST['submit'])) {
    ...
    //  cek data, apakah NIS sudah didaftarkan
     if (isset($_POST['nis'])) {
        ...
        $query = mysqli_query($conn_ekstra, "SELECT nis FROM data_paskib WHERE nis = '$nis'"); 
    ...
    $generateId = 'PP'.date('Y') .sprintf("%05s", $d->id + 1);


        // pros insert data
    $insert = mysqli_query($conn_ekstra, "INSERT INTO data_paskib
        VALUES
        ( '".$generateId."',
        '".$_POST['nama']."',
        '".$_POST['nis']."',
...
<html lang="en">
  <head>
    ...
    <title>Form Pendaftaraan | PASKA PERSADA</title>
  </head>
  <!-- icon fontawsem -->
    ...
    <div class="form_wrapper">
      <div class="form_container">
        <div class="title_container">
          <h2>Formulir Pendaftaran Ekstrakulikuler PASKIB</h2>
        </div>

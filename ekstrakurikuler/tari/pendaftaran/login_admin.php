<?php 
	...
	if(isset($_POST['login'])){
		...
		$cek = mysqli_query($conn_ekstra, "SELECT * FROM admin_tari
    ...
    <div class="global-container">
        <div class="card login-form shadow">
            <div class="card-body text-center">
                ...
                <img src="../../img/Logo_Ekstra/TARI.jpg"  style="width: 59px;  margin: 2px 0px 10px; border-radius: 50%;"  />
            </div>
            <div class="card-text">
                <form action="" method="POST">
                    <div class="mb-3">
                        <input type="username" class="form-control" name="username" id="username"
                            aria-describedby="emailHelp " autofocus placeholder="NIS" required />
                    </div>
                    <div class="mb-3">

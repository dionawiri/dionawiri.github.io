...
<title>Daftar Anggota | Tari</title>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light shadow navbar-expand-sm "style="background-color: #ffc400;" >
    <div class="container " >
     <span class="navbar-brand">
      <img src="../../img/logomuhi/Muhi.png" alt="" width="31" height="31" class="d-inline-block align-text-center fw-bolder">
      <b style ="font-size: 13px; color: black ;">SMK MUHAMMADIYAH 1 WONOSOBO</b>
     </span>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link" href="login_daftar.php" target="_blank">Login Siswa <i class="fas fa-user-friends" style="color: black"></i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="logout.php">Logout <i class="fas fa-sign-out-alt" style='font-size:17px; color: black' ></i></a>
        </li>
      </ul>
    </div>
  </div>
...
<!-- navbar akhir -->
    ...
    $kelas = query("SELECT * FROM data_tari ");
...
// tombol cari diklik
    ...
    <body>
      ...
      <div class="container mt-5">
        <h1 class="text-center jdl fw-bold">Daftar Calon Anggota <span>Tari</span></h1>
      </div>
          ...
          <nav class="navbar navbar-light  " style="background-color:white;">
            <div class="container-fluid">
              <form class="d-flex" action="" method="POST">
                <input class="form-control me-2" size="40" type="search" name="keyword" id="keyword" autofocus
                  placeholder="Cari Data Anggota" aria-label="Search" autocomplete="off">

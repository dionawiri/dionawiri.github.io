<?php 
	...
	if(isset($_POST['login'])){
		...
		$cek = mysqli_query($conn_ekstra, "SELECT * FROM admin_pmr
    ...
    <div class="global-container">
        <div class="card login-form shadow">
            <div class="card-body text-center">
                ...
                <img src="../../img/Logo_Ekstra/PMI.jpg"  style="width: 58px; border-radius: 50% ; margin: 2px 0px 10px" />
            </div>
            <div class="card-text">

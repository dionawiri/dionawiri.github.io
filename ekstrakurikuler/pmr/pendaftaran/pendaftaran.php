...
if(isset($_POST['submit'])) {
    ...
    //  cek data, apakah NIS sudah didaftarkan
     if (isset($_POST['nis'])) {
        ...
        $query = mysqli_query($conn_ekstra, "SELECT nis FROM data_pmr WHERE nis = '$nis'"); 
    ...
    $generateId = 'PMR'.date('Y') .sprintf("%05s", $d->id + 1);


        // pros insert data
    $insert = mysqli_query($conn_ekstra, "INSERT INTO data_pmr
        VALUES
        ( '".$generateId."',
        '".$_POST['nama']."',
        '".$_POST['nis']."',
...
<html lang="en">
  ...
  <link rel="icon" href="../../img/Logo_Ekstra/PMI.png" type="image/gif" sizes="16x16" />
    ...
    <title>Form Pendaftaraan | PMR</title>
  </head>
  <!-- icon fontawsem -->
    ...
    <div class="form_wrapper">
      <div class="form_container">
        <div class="title_container">
          <h2>Formulir Pendaftaran Ekstrakulikuler PMR</h2>
        </div>

...
<title>Daftar Anggota | PMR</title>

</head>
<body>
<!--  Navbar -->
<nav class="navbar fixed-top navbar-expand-lg shadow navbar-expand-sm "style="background-color: #ed1b2e;" >
    <div class="container " >
...
// tombol cari diklik
    ...
    <body>
      ...
      <div class="container mt-5">
        <h1 class="text-center jdl fw-bold">Daftar Calon Anggota <span>PMR</span></h1>
      </div>

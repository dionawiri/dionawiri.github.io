            ...
            <div class="card text-center">
              <div class="card-header">
                <ul class="nav nav-pills card-header-pills pe-2 ps-2">
                  <li class="nav-item">
                    <a class="btn btn-light fw-bolder" style="background-color: #ed1b2e; color: white; border-color: #ffc400" href="../../pmr/index.html" title="Home" role="button" target="_blank"
              ...
              <div class="card-body text-capitalize">
                ...
                <a href="cetak.php?id=<?php echo $_GET['id'] ?>" target="_blank" role="button" class="btn btn-primary" style="background-color: #ffc400; color: #ed1b2e; border-color: #ffc400"
                  >Cetak Kartu &nbsp;
